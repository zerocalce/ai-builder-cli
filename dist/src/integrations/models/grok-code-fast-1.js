...
exports.GrokCodeFast1Provider = void 0;
 ...
 */
class GrokCodeFast1Provider extends events_1.EventEmitter {
    constructor(logger, config) {
        super();
        this.name = 'grok-code-fast-1';
        this.requestCount = 0;
        ...
        this.config = {
            ...
            endpoint: (config === null || config === void 0 ? void 0 : config.endpoint) || 'https://api.x.ai/v1/chat/completions',
            ...config
        };
        // Initialize metrics
        this.metrics = {
    ...
    async initialize() {
        ...
        try {
            ...
            this.logger.error('Failed to initialize Grok Code Fast 1 provider', error);
            throw error;
        }
    }
    async generateResponse(request) {
        ...
        try {
            // Check user consent
            const userId = ((_a = request.metadata) === null || _a === void 0 ? void 0 : _a.userId) || 'anonymous';
            ...
            await this.recordAnalytics({
                ...
                modelId: this.config.modelId,
                userId,
                sessionId: ((_b = request.metadata) === null || _b === void 0 ? void 0 : _b.sessionId) || 'unknown',
                timestamp: new Date(),
                data: {
            ...
            this.logger.error('Failed to generate response from Grok Code Fast 1', error);
    ...
    buildEnhancedPrompt(request) {
        ...
        if ((_a = request.context) === null || _a === void 0 ? void 0 : _a.codeContext) {
        ...
        if ((_b = request.context) === null || _b === void 0 ? void 0 : _b.projectContext) {
    ...
    generateCodeOptimizedResponse(prompt) {
...
Would you like me to provide a specific implementation?`;
    ...
    async updateMetrics(usage, latency, success) {
...
exports.GrokCodeFast1Provider = GrokCodeFast1Provider;
