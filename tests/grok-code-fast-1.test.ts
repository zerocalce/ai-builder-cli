import { GrokCodeFast1Provider } from '../src/integrations/models/grok-code-fast-1';
import { Logger } from '../src/types';

describe('GrokCodeFast1Provider', () => {
  let provider: GrokCodeFast1Provider;
  ...
  beforeEach(() => {
    ...
    provider = new GrokCodeFast1Provider(mockLogger);
  });
